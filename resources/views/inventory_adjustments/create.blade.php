            ...
            <div class="card border-0 shadow-sm p-4">
                <form action="{{ route('inventory_adjustments.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="reason" class="form-control" rows="3" placeholder="Ej: Ingreso por devolución de proveedor, reposición de merma, etc." required></textarea>
                    </div>

                    <div class="alert alert-info border-0 small">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Nota:</strong> Esta acción incrementará el stock actual del producto seleccionado de forma inmediata.
                    </div>
